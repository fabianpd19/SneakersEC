...
VALUES ('johndoe', MD5('password123'), 'johndoe@example.com');
...
VALUES (
    1, -- ID de usuario correspondiente en la tabla usuarios
    'John Doe', 
    '123-456-7890', 
    'https://bootdey.com/img/Content/avatar/avatar7.png', 
    '1234 Elm Street', 
    'Sneaker Enthusiast and Collector.', 
    'Sneaker collecting, streetwear fashion, basketball', 
    'www.example.com'
);
...
-- Asignación de badges al usuario
...
-- Inserción de actividad reciente del usuario
...
-- Inserción de pedidos del usuario
INSERT INTO pedidos (usuario_id, fecha, estado, total)
VALUES 
    (1, '2023-01-15', 'Delivered', 150.00),
    (1, '2023-02-10', 'Pending', 200.00),
    (1, '2023-03-05', 'Cancelled', 250.00);
...
VALUES 
    ('Deportivo Adidas', 'Zapatillas deportivas Adidas', 39.42, 49.99, 10, 1, 1, 1, 'https://www.transparentpng.com/download/adidas-shoes/a4xO3G-adidas-shoes-adidas-shoe-kids-superstar-daddy-grade.png', 4),
    ('Casual Nike', 'Zapatillas casuales Nike', 31.93, 39.99, 15, 2, 2, 2, 'https://www.transparentpng.com/thumb/nike/aSEQ60-nike-transparent-image.png', 3),
    ('Formal Puma', 'Zapatos formales Puma', 49.44, 59.99, 8, 3, 3, 3, 'https://www.transparentpng.com/thumb/adidas/O86IC7-adidas-shoe-clipart-photo.png', 5),
    ('Bota Reebok', 'Botas Reebok para hombres', 45.99, 55.99, 12, 4, 4, 1, 'https://www.police.com.ec/wp-content/uploads/2023/10/Bota-3455.png', 4),
    ...
    ('Deportivo Nike', 'Zapatillas deportivas Nike unisex', 52.30, 62.99, 7, 2, 1, 3, 'https://atleta.ec/4421/zapatos-nike-star-runner-3-gs-negro-da2776-001.jpg', 5);
